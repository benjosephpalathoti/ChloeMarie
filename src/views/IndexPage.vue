...
export default {
  ...
  data() {
    return {
      ...
      circularImages: [
        { src: "/assets/circular/01.jpeg", caption: "Santorini" },
        { src: "/assets/circular/02.jpeg", caption: "Blurry Lights" },
        { src: "/assets/circular/03.jpg", caption: "New York" },
        { src: "/assets/circular/04.png", caption: "Good Boy" },
        { src: "/assets/circular/05.jpeg", caption: "Coastline" },
        { src: "/assets/circular/06.jpeg", caption: "Forest" },
        { src: "/assets/circular/07.jpeg", caption: "City" },
      ],
    };
  },
  mounted() {
